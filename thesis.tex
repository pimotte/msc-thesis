...
The original BarterCast mechanism computed the trust agent $i$ has in agent $j$ by considering
the graph of all agents, with directed edges from one agent to another, where the capacities
...
includes the ability to perform a sybil attack with multiple identities. This defintion
