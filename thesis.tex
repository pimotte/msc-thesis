...
working environment, as well as pizza/gaming night.

Finally, I thank my parents, Arien and Bernard, and my sister Lidwien. They have
     ...
     \begin{figure}[ht]
        \centering
         \begin{tikzpicture}[->,thick,scale=0.8,main node/.style={circle, draw, fill=white,
            ...
            (p2) edge node [above right, pos=0.1] {0} (r2)
