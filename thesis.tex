...
\begin{proof}
    ...
    iterations needed is logarithmic in $\frac1\eps$, yielding the worst-case $O(m\log\farc1\eps)$.
\end{proof}
...
properties of known accounting mechanisms. However, the fact that 
