...
This thesis is my capstone to the master Applied Mathematics at TU Delft.
...
100 units worth of work, the second 70 units and the third 1 unit. The second and third
agent have only interacted with the first. If the first computes scores
in 1-NetFlow, then both the second and third agent are assigned a score of 0 units.
However, in the case of 2-NetFlow, the second agent will have a score of 20 units,
whereas the third will have a score of 0 units still. This is because the scaling
...
\begin{figure}[ht]
    ...
    \subfloat[][]{\includesvg[width=0.47\textwidth]{plots_all/plot_up_down_size_flow2_7}}
    \subfloat[][]{\includesvg[width=0.47\textwidth]{plots_all/plot_up_down_size_flow2_8}}\\
...
\begin{figure}[ht]
    ...
    \centering
        ...
        \subfloat[][]{        \includesvg[width=0.47\textwidth]{plots_all/plot_up_down_size_flow2_9}} 
        \subfloat[][]{        \includesvg[width=0.47\textwidth]{plots_all/plot_up_down_size_flow2_10}} \\

    \caption{NetFlow scores from the perspective of several nodes, continued.}
    \label{fig:nf_alpha_comparison_2}
\end{figure}

\musthave{Fix title, explain things in caption}
...
Agents that are not the biggest contributers scores with an unlogical pattern.
...
is still present. What is different from NetFlow is that for temporal PageRank, the overal
...
\musthave{More specific examples}
...
\musthave{Continue spellcheck}

\musthave{Fix consistency of bibliography}
