...
and the practical performance are the subjects of this thesis.
...
As argued in the introductions, distributed systems can have advantages over traditional centralized
...
Traditionally, the contribution of peers to a bittorrent system have been judged by their
upload/download ratio. In the context of a system like Tribler, this is not per se an accurate
measure of contribution, because the act of relaying 
