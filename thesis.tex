...
Observe that agents P and T have a positive capacity. This means they are eligible for positive
scores, and that they can serve as a conduit for the purposes of transitive trust. 
...
\begin{figure}[h]
    \centering
     \begin{tikzpicture}[->,thick,scale=0.8,main node/.style={circle, draw, fill=white,
        ...
        \node [ForestGreen] [above = 0.3 cm of p] {$12 - 7 = 5$};
