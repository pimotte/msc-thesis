...
In this thesis, the following model is studied.
\begin{definition}[Ordered Interaction Model]
        The Ordered Interaction Model consists of two sets:  
        ...
        Participants are entities that can interact with each other.
