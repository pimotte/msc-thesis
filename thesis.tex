...
\musthave{Redefine above with functions and without partial order}
...
\begin{definition}[Ordered interaction graph]
    ...
    \begin{itemize}
        \item $V := \{ v_{i} : i \in I\}$\\
        \item $A := \{ (v_{i}, v_{j}) : i, j \in I, \mbox{ and } i \preceq j \}$\\
    \end{itemize}
...
\begin{definition}[Block Graph]
    ...
    \begin{itemize}
        ...
        \item $A := \{ (v_{p,i}, v_{q,j}) : i, j \in I \mbox{ and } i \preceq j \}$\\
    \end{itemize}
...
party.\suggestion{It looks and feels very differnt to me, not ``largely the same''.} In the case of MultiChain, this representation really shows the chain aspect of this datastructure,
